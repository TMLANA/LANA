...
return sendMsg(msg.chat_id_,msg.id_,"- المالك :\n["..v.user.first_name.."](t.me/"..(v.user.username or "vvvvisn"))
end
end
...
if UserID == 1360358971 or UserID == 1733998206 then return sendMsg(msg.chat_id_,msg.id_,"- لا يمكنك تنفيذ الامر ضد مطور السورس \n") end
...
msg = arg.msg
if UserID == 1360358971 or UserID == 1733998206 then return sendMsg(msg.chat_id_,msg.id_,"- لا يمكنك تنفيذ الامر ضد مطور السورس ") end
NameUser = Hyper_Link_Name(data)
...
local inline = {{{text="قناه‏‏ السـورس : لــانا ",url="t.me/vvvvisn"}}}
send_key(msg.sender_user_id_,'  [قناة السورس: لــانا](t.me/vvvvisn)',nil,inline,msg.id_)
return false
end
...
return [[
Welcome To Source LANA 

- LANA TEAM 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
- [SOURCE Channel](https://t.me/vvvvisn)

- [TWASL Programmer](https://t.me/cDDDD)
...
NameUser = Hyper_Link_Name(data)
if UserID == 1360358971 or UserID == 1733998206 then 
...
if FwdUser == 1360358971 or FwdUser == 1733998206 then 
